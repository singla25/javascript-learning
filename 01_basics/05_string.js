...
console.log(otherName.__proto__); // Accessing prototype of string object
console.log();
...
console.log("otherName.concat(' my name')): ", otherName.concat(' is my name')); // Concatenating string object with another string
console.log();
